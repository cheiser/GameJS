<?php
  $d = explode("/", trim($path, "/"));
  $srcUrl = './mall/source.php?dir=' . end($d) . '&amp;file=' . basename($_SERVER["PHP_SELF"]) . '#file'; // source.php included here to show server side source
?>
...
<script src="./mall/myUtilities.js"></script> <!-- good to have code -->

<script src="main.js"></script> <!-- will make a new one of this for each new page -->
</body>
</html>